      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-white/70 mb-12 max-w-md">
            Whether you are planning a new home, renovating a commercial space, or need construction consultancy, we are here to help.
          </p>
          ...
          <div className="space-y-8 mb-12">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h4 className="text-lg font-heading font-semibold mb-1">Office Location</h4>

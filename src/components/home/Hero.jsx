        ...
        <div className="lg:col-span-7 pt-32 md:pt-40">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a href="tel:+919232660441" className="px-8 py-4 bg-accent text-primary rounded-xl font-bold hover:bg-white transition-all duration-300 flex items-center gap-2 group">
              ...
              <a href="https://wa.me/919232660441" target="_blank" rel="noreferrer" className="px-8 py-4 bg-accent text-primary rounded-xl font-bold hover:bg-white transition-all duration-300 flex items-center gap-2 group">

...
const reasons = [
  { icon: Users, title: 'Experienced Engineers', desc: 'Our team consists of highly experienced and skilled civil engineers.' },
  { icon: BadgeIndianRupee, title: 'Affordable Pricing', desc: 'We deliver premium quality services at highly competitive prices.' },
  { icon: Clock, title: 'Fast & On-Time Work', desc: 'We guarantee timely project completion without any delays.' },
  { icon: Target, title: 'Accurate Survey & Design', desc: 'Using modern tools like DGPS to ensure absolute accuracy.' },
  { icon: Headset, title: 'Customer Support', desc: 'Dedicated around-the-clock support and guidance for our clients.' },
  { icon: HardHat, title: 'Quality Assurance', desc: 'Strict supervision and use of premium standardized materials.' },
  { icon: Monitor, title: '3D Visualizations', desc: 'Realistic 3D renderings to visualize your dream space.' },
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/3">
             <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-accent font-medium tracking-widest uppercase text-sm">Why Us</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-primary mb-6 leading-tight">
              Why We Are The <span className="text-secondary font-light italic">Best Choice</span>
            </h2>

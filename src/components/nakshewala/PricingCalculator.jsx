...
const services = [
  { id: '2d', name: '2D प्लान', price: 2, unit: 'sqft' },
  { id: 'ruf', name: 'रफ प्लान (Ruf Plan)', price: 1, unit: 'sqft' },
  { id: '3d', name: '3D एलिवेशन', price: 4, unit: 'sqft' },
  { id: 'interior', name: 'इंटीरियर', price: 8, unit: 'sqft' },
  { id: 'site', name: 'साइट विजिट', price: 800, unit: 'flat' },
  { id: 'dgps', name: 'DGPS सर्वे', price: 3000, unit: 'acre' }
]
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4">
            सर्विस <span className="text-accent italic font-light">सिलेक्ट करें</span>
          </h2>
          <p className="text-white/60 max-w-2xl mx-auto">
            अपने प्रोजेक्ट की अनुमानित लागत तुरंत कैलकुलेट करें।
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto glass-dark p-8 md:p-12 rounded-[2rem]">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4" onClick={() => handleToggle(service.id)}>
                    ...
                    <span className="text-accent font-medium">₹{service.price}/{service.unit === 'flat' ? 'विजिट' : service.unit}</span>
                  </div>
                  ...
                  {isSelected && service.unit !== 'flat' && (
                    <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between animate-fade-up">
                      <label className="text-sm text-white/60">क्षेत्रफल दर्ज करें ({service.unit}):</label>
                      <input 
                        type="number" 
                        min="1"
          ...
          <div className="bg-background/10 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 border border-white/10">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <a href="#payment" className="flex-1 md:flex-none px-8 py-4 bg-accent text-white text-center rounded-full font-medium hover:bg-white hover:text-primary transition-all duration-300">
